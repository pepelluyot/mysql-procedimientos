/*Crear una función (​ ejemplo16_fun.sql​ ) de manera que reciba una cantidad de euros y devuelva el valor expresado en pesetas. Llamar a dicha función en el interior de una select*/
